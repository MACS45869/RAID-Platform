...
namespace RAIDPlatform.Data.Repositories.Migrations
{
    ...
    [Migration("20221123133042_initial")]
            ...
            modelBuilder.Entity("RAIDPlatform.Data.Models.Client.Client_Application_Security_Group_Feature_Map.Client_Application_Security_Group_Feature_Map", b =>
                {
                    ...
                    b.Property<int>("ClientFeatureIDId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RAIDPlatform.Data.Models.Client.Client_Application_Security_Group_Feature_Map.Client_Application_Security_Group_Feature_Map", b =>
                {
                    ...
                    b.HasOne("RAIDPlatform.Data.Models.Client.Client_Features.Client_Features", "ClientFeatureID")
                        .WithMany()
                        .HasForeignKey("ClientFeatureIDId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ClientApplicationSecurityGroup");

                    b.Navigation("ClientFeatureID");
                });
